...
public final class ThemeManager {
    ...
    private static List<ThemeDefinition> createBuiltIns() {
        return List.of(
                ...
                theme("deep-ocean", "Deep Ocean", "#030A16", "#071426", "#0D223B", "#224C73",
                        "#E5F2FC", "#9CB5C9", "#2FA8FF"),
                ...
                theme("amethyst-night", "Amethyst Night", "#10091A", "#190F26", "#251638", "#46305D",
                        "#F1E8FA", "#B7A3C8", "#B47CFF"),
                theme("crimson-noir", "Crimson Noir", "#16080D", "#210D14", "#31151E", "#58303C",
                        "#F8E8EC", "#C7A1AA", "#F0647A"),
                theme("amber-terminal", "Amber Terminal", "#0D0D08", "#15150D", "#202014", "#3E3B24",
                        "#F2EFD8", "#B9B394", "#D6A928"),
                theme("moss-circuit", "Moss Circuit", "#0B1107", "#121A0D", "#1C2814", "#364B29",
                        "#EBF4E5", "#A6B99B", "#8FCB4D"),
                theme("studio-light", "Lavender Studio", "#ECE2F5", "#FAF6FF", "#E1D5EE", "#C0ACD4",
                        "#251B30", "#665675", "#7451B8"),
                theme("sage-light", "Sage Light", "#EEF3F0", "#FAFCFB", "#E1EAE5", "#BFCFC6",
                        "#17231D", "#50655A", "#2F7D5B"),
                theme("rose-quartz", "Rose Quartz", "#F8EFF3", "#FFF9FB", "#F0DEE6", "#D8B6C4",
                        "#2D1721", "#74505F", "#B73E69"),
                theme("canary-light", "Canary Light", "#F5F7E7", "#FDFEF7", "#E9EDC9", "#C5CC83",
                        "#22250F", "#5D6430", "#6E7F00"),
                theme("coral-bloom", "Coral Bloom", "#FFF0EC", "#FFF9F7", "#F5DDD6", "#DCB0A5",
                        "#321A15", "#795148", "#C34E36"),
                theme("aqua-day", "Aqua Day", "#E8F7F7", "#F8FEFE", "#D5EEEE", "#A7D0D2",
                        "#10292B", "#46686B", "#007C84")
        );
    }
